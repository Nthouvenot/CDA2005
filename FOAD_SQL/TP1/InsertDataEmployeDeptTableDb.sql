-- we select the employees_management databse before adding data
USE employees_management;

-- adding data in the dept table
INSERT INTO dept(DEPTNO, DNAME, LOC) VALUES(10, 'ACCOUNTING', 'NEW YORK');
INSERT INTO dept(DEPTNO, DNAME, LOC) VALUES(20, 'RESEARCH', 'DALLAS');
INSERT INTO dept(DEPTNO, DNAME, LOC) VALUES(30, 'SALES', 'CHICAGO');
INSERT INTO dept(DEPTNO, DNAME, LOC) VALUES(40, 'OPERATIONS', 'BOSTON');

-- adding data in the emp table
...
INSERT INTO emp(EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, DEPTNO) VALUES(7782, 'CLARK', 'MANAGER', 7839, '1981-07-09', 2450, 10);
