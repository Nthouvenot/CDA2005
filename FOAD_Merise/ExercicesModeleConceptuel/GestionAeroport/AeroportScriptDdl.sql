...
Engine_Power SMALLINT(3) UNSIGNED NOT NULL,
Number_Of_Place SMALLINT(3) UNSIGNED NOT NULL,
...
Owner_Zip_Code MEDIUMINT(5) NOT NULL,
Owner_Street VARCHAR(100) NOT NULL,
Owner_Street_Number SMALLINT(3) UNSIGNED NOT NULL,
...
Mechanic_Zip_Code MEDIUMINT(5) NOT NULL,
Mechanic_Street VARCHAR(100) NOT NULL,
Mechanic_Street_Number SMALLINT(3) UNSIGNED NOT NULL,
...
Pilot_Zip_Code MEDIUMINT(5) NOT NULL,
Pilot_Street VARCHAR(100) NOT NULL,
Pilote_Street_Number SMALLINT(3) UNSIGNED NOT NULL,
...
Plane_Type_Name VARCHAR(10) NOT NULL,
License_Number CHAR(13) NOT NULL,
Number_Of_Fly SMALLINT(3) UNSIGNED NOT NULL,
